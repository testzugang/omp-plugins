...
description: Use when an agent needs to review, validate, or clean up AGENTS.md for contradictions, unclear instructions, stale harness-specific tool names, or unsafe automation guidance.
---
...
Flag Claude Code-specific content when it appears in `AGENTS.md` but the file is intended for OMP or generic coding agents:
...
- slash commands that do not exist in OMP
