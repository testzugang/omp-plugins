...
def load_config(config_override: str | None = None) -> dict[str, Any]:
    ...
    home_config = Path.home() / ".omp" / "dependency-audit.json"
    merged: dict[str, Any] = {}
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    p.add_argument("--config", default="", help="Optional dependency-audit config JSON path. Overrides skill default and ~/.omp/dependency-audit.json")
